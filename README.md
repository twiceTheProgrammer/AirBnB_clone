...
This is the first part of many of AirBnB clone.
this project focuses on the first part which is the creation of models and proper classes and test them using a console UI.
